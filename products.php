		...
		if($result == false){
			...
			if (mysqli_num_rows($result)>0){
				while($row = mysqli_fetch_assoc($result)){
					echo "<tr><td><a href=\"products.php?id=".$row["product_id"]."\">".$row["product_id"]."</a></td>"."<td>".$row["product_photo_url"]."</td>"."<td>".$row["category_id"]."</td>"."<td>".$row["product_name"]."</td>"."<td>".$row["product_description"]."</td>"."<td>".$row["price"]."</td>"."<td>".$row["special_price"]."</td>"."<td>".$row["quantity"]."</td>"."<td>".$row["entry_time"]."</td></tr>";
				}
			}
			else {
